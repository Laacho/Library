...
public class UserTableViewProcessorTest {

    @Mock
    private UserCredentialsRepository userCredentialsRepository;

    private UsersTableViewProcessor saveInArchivedProcessor;
    @BeforeEach
    public void setUp() throws Exception {
        SingletonFactory.init();
        saveInArchivedProcessor =SingletonFactory.getSingletonInstance(UsersTableViewProcessor.class);
    }
    @Test
    ...
    void getInstance() {
        ...
        assertInstanceOf(UsersTableViewOperationModel.class, saveInArchivedProcessor);
    }
    @Test
