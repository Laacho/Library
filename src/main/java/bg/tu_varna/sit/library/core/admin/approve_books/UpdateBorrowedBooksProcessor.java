...
public class UpdateBorrowedBooksProcessor extends BaseProcessor implements UpdateBorrowedBooksOperationModel {
    ...
    private final NotificationRepository notificationRepository;
        private static final Logger log=Logger.getLogger(UpdateBorrowedBooksProcessor.class);
    ...
    public Either<Exception, UpdateBorrowedBooksOutputModel> process(UpdateBorrowedBooksInputModel input) {
        return Try.of(() -> {
            log.info("Started updating borrowing books");
                    ...
                    UpdateBorrowedBooksOutputModel output = UpdateBorrowedBooksOutputModel.builder()
                            .meesage("Successfully updated borrowed books")
                            .build();
                    log.info("Finished updating borrowing books");
                    return output;
                }).toEither()
